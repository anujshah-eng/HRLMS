...
class AIInterviewRolesRepository:
    ...
    async def create_question(self, question_text: str, topic: str | None, role_id: int | None, expected_keywords: str | None):
    ...
    async def update_question(self, question_id: int, question_text: str | None, topic: str | None, role_id: int | None, expected_keywords: str | None, is_active: bool | None):
        """Update a question"""
        try:
            async with db_resource_manager.async_session() as session:
                result = await session.execute(
                ...
                if expected_keywords is not None:
                    question.expected_keywords = expected_keywords
